#
#  Be sure to run `pod spec lint TDInputBar.podspec' to ensure this is a
...
s.summary      = "An InputBar same as QQ or WeChat"
  ...
  # Or just: s.author    = "kong"
  # s.authors            = { "kong" => "m18301125620@163.com" }
  # s.social_media_url   = "http://twitter.com/kong"
